...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.create_organization(10)   # creates 10 organizations
        self.create_students(50)        # creates 50 students
        self.create_membership(10)      # creates 10 memberships
    ...
    def create_students(self, count):
        fake = Faker('en_PH')  # Philippine names
        for _ in range(count):
